This Repository contains code for Alzheimer's Disease detection using EEG signals. It uses some signal processing concepts to clean up the dataset files. 
